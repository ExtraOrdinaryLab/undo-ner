...
class UnmaskingLlamaModel(LlamaModel):
    """
    UnmaskingLlamaModel is a modified version of LlamaModel that removes the causal mask,
...
class UnmaskingLlamaForTokenClassification(LlamaPreTrainedModel):
    """
    Llama model with a token classification head on top, but with bidirectional attention.
    This is achieved by using the UnmaskingLlamaModel which removes the causal mask.
    """
    ...
    def __init__(self, config):
        ...
        # Use the UnmaskingLlamaModel instead of the standard LlamaModel
    ...
    def forward(
        ...
        **flash_attn_kwargs: Unpack[FlashAttentionKwargs],
        ...
        Args:
            ...
            cache_position: Cache position for static cache
